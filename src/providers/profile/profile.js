...
let ProfileProvider = class ProfileProvider {
    ...
    getBackupGroupInfo(keyId, wallet) {
        ...
        return this.persistenceProvider
            ...
            .then((timestamp) => __awaiter(this, void 0, void 0, function* () {
            if (timestamp) {
                return Promise.resolve({ needsBackup: false, timestamp });
            }
            else {
    ...
    showInAppNotification(title, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Observable.timer(7000).toPromise();
            infoSheet.dismiss();
        });
    }
    ...
    addAndBindWalletClients(data, opts = { bwsurl: null, keyId: null }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.askToEncryptKey(data.key).then(() => {
                ...
                return this.keyProvider.addKey(data.key).then(() => __awaiter(this, void 0, void 0, function* () {
    ...
    importFile(str, opts) {
        return this._importFile(str, opts).then((data) => __awaiter(this, void 0, void 0, function* () {
            if (opts.keyId) {
                // re-import attempt
                if (this.checkIfCorrectWalletToReImport(opts.keyId, data.key)) {
                    const wallets = this.getWalletsFromGroup({
    ...
    importWithDerivationPath(opts) {
        return new Promise((resolve, reject) => {
            ...
            this._importWithDerivationPath(opts)
                ...
                data.walletClient.openWallet((err) => __awaiter(this, void 0, void 0, function* () {
                    if (err) {
    ...
    setOrderedWalletsByGroup() {
        ...
        this.orderedWalletsByGroup = _.values(_.groupBy(_.flatten(wallets), 'keyId'));
    }
    ...
    getWalletsFromGroup(opts) {
        ...
        if (opts.minFiatCurrency) {
            ret = ret.filter(wallet => {
                if (_.isEmpty(wallet.cachedStatus))
                    return true;
