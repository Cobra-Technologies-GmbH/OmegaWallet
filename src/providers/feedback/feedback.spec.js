...
describe('FeedbackProvider', () => {
    ...
    describe('isVersionUpdated function', () => {
        it('reject if cannot verify the format of version tag', () => {
            ...
            const isVersionUpdatedSpy = feedbackProvider.isVersionUpdated(currentVersion, savedVersion);
            expect(isVersionUpdatedSpy).toBe('Cannot verify the format of version tag: ' + currentVersion);
        });
        it('reject if cannot verify the format of the saved version tag', () => {
            ...
            const isVersionUpdatedSpy = feedbackProvider.isVersionUpdated(currentVersion, savedVersion);
            expect(isVersionUpdatedSpy).toBe('Cannot verify the format of the saved version tag: ' + savedVersion);
        });
