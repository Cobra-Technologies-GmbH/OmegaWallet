...
describe('ScanProvider', () => {
    ...
    describe('Mobile: ', () => {
        ...
        describe('gentleInitialize', () => {
            it('should get scanner status and complete initialization if initializations already started', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                spyOn(qrScanner, 'getStatus').and.returnValue(Promise.resolve(statusMock));
                yield scanProvider
                    .gentleInitialize()
                    .then(() => {
                    expect().nothing();
                ...
                expect(eventsPublishSpy).toHaveBeenCalledWith('scannerServiceInitialized');
                expect(debugSpy).toHaveBeenCalledTimes(5); // logCapabilities()
            }));
            it('should initialize scanner if it was authorized and set initializeStarted with true', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                spyOn(qrScanner, 'getStatus').and.returnValue(Promise.resolve(statusMock));
                const initializeSpy = spyOn(scanProvider, 'initialize').and.returnValue(Promise.resolve());
                yield scanProvider
                    .gentleInitialize()
                    .then(() => {
                    expect().nothing();
            ...
            it("should not initialize scanner if it wasn't authorized and set initializeStarted with true", () => __awaiter(void 0, void 0, void 0, function* () {
                scanProvider.initializeStarted = false;
                const statusMock = {
                    authorized: false,
                    denied: false,
        ...
        describe('initialize', () => {
            it('should initialize the scanner through prepare funtion', () => __awaiter(void 0, void 0, void 0, function* () {
                const statusMock = {
                    authorized: true,
                    denied: false,
                    restricted: false,
                ...
                spyOn(qrScanner, 'prepare').and.returnValue(Promise.resolve(statusMock));
                yield scanProvider
                    .initialize()
                    .then(() => {
                    expect().nothing();
            ...
            it('should set isAvailable with false if prepare returns error, and call completeInitialization', () => __awaiter(void 0, void 0, void 0, function* () {
                const statusMock = {
                    authorized: false,
                    denied: false,
                    restricted: false,
        ...
        describe('activate', () => {
            it('should show the scanner and check capabilities', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        describe('toggleLight', () => {
            it('should turn on the light of the camera', () => __awaiter(void 0, void 0, void 0, function* () {
                scanProvider.lightEnabled = false;
                const enableLightSpy = spyOn(qrScanner, 'enableLight').and.returnValue(Promise.resolve());
                yield scanProvider
                    .toggleLight()
                    .then((isLightEnabled) => {
            ...
            it('should turn off the light of the camera', () => __awaiter(void 0, void 0, void 0, function* () {
                scanProvider.lightEnabled = true;
                const disableLightSpy = spyOn(qrScanner, 'disableLight').and.returnValue(Promise.resolve());
                yield scanProvider
                    .toggleLight()
                    .then((isLightEnabled) => {
        ...
        describe('toggleCamera', () => {
            it('should enable the front camera', () => __awaiter(void 0, void 0, void 0, function* () {
                scanProvider.frontCameraEnabled = false;
                const useFrontCameraSpy = spyOn(qrScanner, 'useFrontCamera').and.returnValue(Promise.resolve());
                yield scanProvider
                    .toggleCamera()
                    .then((isfrontCameraEnabled) => {
            ...
            it('should enable the back camera', () => __awaiter(void 0, void 0, void 0, function* () {
                scanProvider.frontCameraEnabled = true;
                const useBackCameraSpy = spyOn(qrScanner, 'useBackCamera').and.returnValue(Promise.resolve());
                yield scanProvider
                    .toggleCamera()
                    .then((isfrontCameraEnabled) => {
    ...
    describe('Desktop: ', () => {
        ...
        describe('gentleInitialize', () => {
            it('should not pre-initialize the camera on desktop', () => __awaiter(void 0, void 0, void 0, function* () {
