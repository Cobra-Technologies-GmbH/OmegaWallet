...
describe('Provider: Email Notifications Provider', () => {
    ...
    describe('updateEmail function', () => {
        it('should exit function if options has not email', () => {
            ...
            expect(emailNotificationsProvider.updateEmail(optsWithoutEmail)).toBeUndefined();
        });
    ...
    describe('getEmailIfEnabled function', () => {
        ...
        it('should return email', () => {
            emailNotificationsProvider.updateEmail(opts);
            expect(emailNotificationsProvider.getEmailIfEnabled()).toEqual('test@bitpay.com');
        });
    });
...
//# sourceMappingURL=email-notifications.spec.js.map