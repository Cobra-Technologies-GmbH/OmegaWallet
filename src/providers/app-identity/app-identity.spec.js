...
describe('AppIdentityProvider', () => {
    let appIdentityProvider;
    let identityFromPersitence;
    ...
    describe('getIdentity', () => {
        ...
        it('should get error if bitauthService fails', () => {
            ...
            identityFromPersitence = Promise.resolve(identityMock);
            spyOn(bitauthService, 'getPublicKeyFromPrivateKey').and.throwError('Error');
            const cb = (_err, _appIdentity) => {
...
//# sourceMappingURL=app-identity.spec.js.map