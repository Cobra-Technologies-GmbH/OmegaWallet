...
import { sendMaxInfoMock, statusMock, txsFromLocal, WalletMock } from './mocks/wallet.mock';
describe('Provider: Wallet Provider', () => {
    let bwcErrorProvider;
    let configProvider;
    let feeProvider;
    let rateProvider;
    let touchidProvider;
    ...
    class PersistenceProviderMock {
        ...
        fetchTxHistory(_walletId) {
            return Promise.resolve(txsFromLocal);
        }
        storeConfig(config) {
            return Promise.resolve(config);
        }
        setTxHistory(_walletId, _txs) {
            return Promise.resolve();
        }
        removeTxHistory(_walletId) {
            return Promise.resolve();
        }
        clearLastAddress(_walletId) {
            return Promise.resolve();
        }
        getTxHistory(_walletId) {
            return Promise.resolve(txsFromLocal);
        }
        getKeys() {
            return Promise.resolve([
    ...
    beforeEach(() => {
        ...
        spyOn(feeProvider, 'getFeeLevels').and.returnValue(Promise.resolve({
            levels: {
                livenet: [
                    {
                        feePerKb: 10000,
    ...
    describe('Function: fetchStatus', () => {
        beforeEach(() => {
            ...
            spyOn(rateProvider, 'whenRatesAvailable').and.returnValue(Promise.resolve());
        ...
        it('should get the status from a wallet that already have cachedStatus and pendingTxps, without opts', () => {
            const wallet = new WalletMock();
            const opts = {};
            const pendingTxp = new PendingTxpMock();
        ...
        it('should set different statusForUs for different action types', () => {
            const wallet = new WalletMock();
            const opts = {};
            const pendingTxp1 = new PendingTxpMock();
            const pendingTxp2 = new PendingTxpMock();
            pendingTxp2.actions = [
                {
                    version: '1.0.0',
    ...
    describe('Function: getAddressView', () => {
        it('should get the correct address with protocol format for BCH testnet', () => {
            spyOn(txFormatProvider, 'toCashAddress').and.returnValue('qqfs4tjymy5cs0j4lz78y2lvensl0l42wu80z5jass');
            const address = walletProvider.getAddressView(Coin.BCH, 'testnet', 'qqfs4tjymy5cs0j4lz78y2lvensl0l42wu80z5jass');
            expect(address).toEqual('bchtest:qqfs4tjymy5cs0j4lz78y2lvensl0l42wu80z5jass');
        });
        it('should get the correct address with protocol format for BCH livenet', () => {
            spyOn(txFormatProvider, 'toCashAddress').and.returnValue('qz8ds306px5n65gffn8u69vvnksfw6huwyjczrvkh3');
            const address = walletProvider.getAddressView(Coin.BCH, 'livenet', 'qz8ds306px5n65gffn8u69vvnksfw6huwyjczrvkh3');
            expect(address).toEqual('bitcoincash:qz8ds306px5n65gffn8u69vvnksfw6huwyjczrvkh3');
        });
        it("should return the same address if it isn't BCH", () => {
            const address = walletProvider.getAddressView(Coin.BTC, 'livenet', '3DTdZeycDBaimjuuknVGrG8fxdLbjsAjXN');
    ...
    describe('Function: removeAndMarkSoftConfirmedTx', () => {
        ...
        it('should filter soft confirmed Txs', () => {
            const filteredTxs = walletProvider.removeAndMarkSoftConfirmedTx(txs);
    ...
    describe('Function: getTx', () => {
        ...
        it("Should get the tx info if wallet hasn't a completeHistory", () => {
            const wallet = new WalletMock();
            spyOn(walletProvider, 'fetchTxHistory').and.returnValue(Promise.resolve([
                {
                    amount: 10000,
                    fees: 99,
                    txid: 'txid1'
    ...
    describe('Function: signTx', () => {
        it('Should return the signed txid', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const pass = 'password';
            spyOn(keyProvider, 'sign').and.returnValue(Promise.resolve('signatures'));
            walletProvider
        ...
        it('Should return an ethereum txp with signed rawTx', () => __awaiter(void 0, void 0, void 0, function* () {
            yield keyProvider.load();
            const wallet = new WalletMock();
            const txp = {
                txid: 'txid1',
    ...
    describe('Function: prepare', () => {
        it('Should call touchidProvider and then handleEncryptedWallet', () => __awaiter(void 0, void 0, void 0, function* () {
            const wallet = new WalletMock();
            yield keyProvider.load();
            spyOn(keyProvider, 'handleEncryptedWallet').and.returnValue(Promise.resolve('password1'));
    ...
    describe('Function: publishAndSign', () => {
        const wallet = new WalletMock();
        let txp;
        it('Should prepare, sign and broadcast the txp if the status is pending', () => __awaiter(void 0, void 0, void 0, function* () {
            yield keyProvider.load();
            txp = {
                txid: 'txid1',
                coin: 'btc',
        ...
        it('Should prepare, sign and broadcast ethereum txp if the status is pending', () => __awaiter(void 0, void 0, void 0, function* () {
            yield keyProvider.load();
            txp = {
                txid: 'txid1',
                coin: 'eth',
        ...
        it('Should prepare, publish, sign and broadcast the txp if the status is accepted', () => __awaiter(void 0, void 0, void 0, function* () {
            yield keyProvider.load();
            txp = {
                txid: 'txid1',
                coin: 'btc',
        ...
        it('Should prepare, publish, sign and broadcast ethereum txp if the status is accepted', () => __awaiter(void 0, void 0, void 0, function* () {
            yield keyProvider.load();
            txp = {
                txid: 'txid1',
                coin: 'eth',
    ...
    describe('Function: getEncodedWalletInfo', () => {
        ...
        it('Should get the encoded wallet info for a BIP44 wallet', () => __awaiter(void 0, void 0, void 0, function* () {
            yield keyProvider.load();
            pass = 'password1';
            spyOn(keyProvider, 'getBaseAddressDerivationPath').and.returnValue("m/44'/0'/0'");
            walletProvider
                .getEncodedWalletInfo(wallet, pass)
                .then(walletInfo => {
                expect(walletInfo).toEqual("1|mom mom mom mom mom mom mom mom mom mom mom mom|livenet|m/44'/0'/0'|false|btc");
            })
                .catch(err => {
                expect(err).toBeUndefined();
            });
        }));
        it('Should get the encoded wallet info for a BIP44 wallet without mnemonics', () => __awaiter(void 0, void 0, void 0, function* () {
            yield keyProvider.load();
            pass = 'password2';
            spyOn(keyProvider, 'getBaseAddressDerivationPath').and.returnValue("m/44'/0'/0'");
            ...
            walletProvider
                .getEncodedWalletInfo(wallet, pass)
                .then(walletInfo => {
                expect(walletInfo).toEqual("2|xPrivKey2|livenet|m/44'/0'/0'|false|btc");
            })
                .catch(err => {
                expect(err).toBeUndefined();
            });
    ...
    describe('Function: getKeysWithPassword', () => {
        const wallet = new WalletMock();
        let pass;
        it('Should get the keys of a wallet', () => __awaiter(void 0, void 0, void 0, function* () {
            yield keyProvider.load();
            pass = 'password1';
    ...
    describe('Function: getKeys', () => {
        ...
        it('Should get the keys of a wallet', () => __awaiter(void 0, void 0, void 0, function* () {
            yield keyProvider.load();
            spyOn(keyProvider, 'askPassword').and.returnValue(Promise.resolve('password1'));
            walletProvider
                .getKeys(wallet)
                .then(keys => {
                expect(keys).toEqual({
