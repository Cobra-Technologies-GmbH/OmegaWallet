...
describe('RateProvider', () => {
    ...
    let btcUrl = 'https://bws.omega.eco/bws/api/v3/fiatrates/btc';
    let bchUrl = 'https://bws.omega.eco/bws/api/v3/fiatrates/bch';
    let ethUrl = 'https://bws.omega.eco/bws/api/v3/fiatrates/eth';
    let xrpUrl = 'https://bws.omega.eco/bws/api/v3/fiatrates/xrp';
    let paxUrl = 'https://bws.omega.eco/bws/api/v3/fiatrates/pax';
    let usdcUrl = 'https://bws.omega.eco/bws/api/v3/fiatrates/usdc';
    let gusdUrl = 'https://bws.omega.eco/bws/api/v3/fiatrates/gusd';
    let busdUrl = 'https://bws.omega.eco/bws/api/v3/fiatrates/busd';
    ...
    let fiatRateUrl = 'https://bws.omega.eco/bws/api/v1/fiatrates/USD?coin=btc&ts=1559315523000';
    beforeEach(() => {
...
//# sourceMappingURL=rate.spec.js.map