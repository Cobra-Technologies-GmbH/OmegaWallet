...
describe('Derivation Path Helper Provider', () => {
    ...
    it('should fail trying to parse an unsupported derivation path BTC', () => {
        ...
        expect(service.isValidDerivationPathCoin("m/44'/0'/0'", 'btc')).toEqual(true);
        expect(service.isValidDerivationPathCoin("m/44'/0'/1'", 'btc')).toEqual(true);
        expect(service.isValidDerivationPathCoin("m/48'/145'/0'", 'btc')).toEqual(false);
        expect(service.isValidDerivationPathCoin("m/48'/145'/10'", 'btc')).toEqual(false);
        expect(service.isValidDerivationPathCoin("m/44'/14'/0'", 'btc')).toEqual(false);
    });
    it('should fail trying to parse an unsupported derivation path BCH', () => {
        ...
        expect(service.isValidDerivationPathCoin("m/44'/145'/0'", 'bch')).toEqual(true);
        expect(service.isValidDerivationPathCoin("m/44'/145'/10'", 'bch')).toEqual(true);
    });
});
//# sourceMappingURL=derivation-path-helper.spec.js.map