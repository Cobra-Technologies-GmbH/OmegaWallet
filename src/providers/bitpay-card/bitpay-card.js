...
let BitPayCardProvider = class BitPayCardProvider {
    ...
    filterTransactions(type, txns) {
        var list, getPreAuth = _.filter(txns, txn => {
            ...
            this.getCards(data => {
                ...
                this.bitPayProvider.post('/api/v2/' + card.token, json, data => {
                    ...
                    this.bitPayProvider.post('/api/v2/' + card.token, json, data => {
                        ...
                        this.logger.info('Error loading Omega Card transaction history for ', 'card id: ', cardId, 'Message: ', data.error);
                        return cb(this._setError('Omega Card Error: Get History', data));
                    });
                }, data => {
                    this.logger.info('Error loading Omega Card invoice history for ', 'card id: ', cardId, 'Message: ', data.error);
                    return cb(this._setError('Omega Card Error: Get Invoices', data));
                });
            });
        });
    }
    ...
    get(opts) {
        ...
        return new Promise(resolve => {
            this.getCards(cards => {
                ...
                const completeBalance = () => __awaiter(this, void 0, void 0, function* () {
