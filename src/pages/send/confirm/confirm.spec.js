...
describe('ConfirmPage', () => {
    ...
    let errorsProvider;
    let testBed;
    beforeEach(async(() => TestUtils.configurePageTestingModule([ConfirmPage]).then(testEnv => {
    ...
    describe('Lifecycle Hooks', () => {
        describe('ionViewDidLoad', () => {
            ...
            it('should display an error message if attempting to send to an old bch address', () => {
                ...
                const popupSpy = spyOn(instance.popupProvider, 'ionicConfirm').and.returnValue(Promise.resolve());
                instance.ionViewDidLoad();
                expect(popupSpy).toHaveBeenCalled();
            });
            it('should instantiate the wallet selector with relevant wallets', () => {
                const setWalletSelectorSpy = spyOn(instance, 'setWalletSelector').and.returnValue(Promise.resolve());
                spyOn(instance.actionSheetProvider, 'createWalletSelector').and.returnValue({
                    present() { },
                    onDidDismiss() { }
                });
                instance.wallets = [{}, {}];
    ...
    describe('Methods', () => {
        describe('chooseFeeLevel', () => {
            it('should display a fee modal', () => {
                const appSheet = spyOn(instance.actionSheetProvider, 'createChooseFeeLevel').and.returnValue({
                    present() { },
                    onDidDismiss() { }
                });
        ...
        describe('confirmTx', () => {
            it('should display a confirm popup', () => {
                const txp = { coin: 'btc' };
                const wallet = {};
                spyOn(instance.txFormatProvider, 'formatToUSD').and.returnValue(Promise.resolve('100.50'));
        ...
        describe('approve', () => {
            ...
            const txp = { coin: 'btc' };
            const wallet = {};
            it('should clear the ongoing process loader if user declines', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                yield instance.approve(tx, wallet);
                expect(clearSpy).toHaveBeenCalled();
            }));
            it('should publish and sign upon approval', () => __awaiter(void 0, void 0, void 0, function* () {
                spyOn(instance, 'getTxp').and.returnValue(Promise.resolve(txp));
        ...
        describe('onlyPublish', () => {
            it('should open the finish modal on success', () => __awaiter(void 0, void 0, void 0, function* () {
                spyOn(instance.walletProvider, 'onlyPublish').and.returnValue(Promise.resolve());
                const modalSpy = spyOn(instance, 'openFinishModal');
                yield instance.onlyPublish();
                expect(modalSpy).toHaveBeenCalled();
            }));
            it('should show error info sheet on failure', () => __awaiter(void 0, void 0, void 0, function* () {
                spyOn(instance.walletProvider, 'onlyPublish').and.returnValue(Promise.reject('error'));
