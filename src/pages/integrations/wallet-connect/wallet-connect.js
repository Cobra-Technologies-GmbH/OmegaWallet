...
// Providers
import { ActionSheetProvider, AnalyticsProvider, ErrorsProvider, ExternalLinkProvider, Logger, PersistenceProvider, PlatformProvider, PopupProvider, ProfileProvider, ReplaceParametersProvider, WalletConnectProvider } from '../../../providers';
...
let WalletConnectPage = class WalletConnectPage {
    ...
    openScanner() {
        this.navCtrl.push(ScanPage, { fromWalletConnect: true }, { animate: false });
    }
    openExternalLink(url) {
        this.externalLinkProvider.open(url);
    }
};
WalletConnectPage = __decorate([
    Component({
