...
let BitPayCardTopUpPage = class BitPayCardTopUpPage {
    ...
    ionViewWillEnter() {
        ...
        this.bitPayCardProvider
            ...
            if (Coin[this.currency]) {
                ...
                this.wallets = this.profileProvider.getWallets(Object.assign(Object.assign({}, walletOptions), { minAmount: amountSat }));
            }
            else {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.walletProvider
                ...
                this.payproProvider
                    ...
                    this.logger.debug(`PayProDetails instructions amount ${_.sumBy(instructions, 'amount')}`);
                    let txp = {
                        coin: wallet.coin,
    ...
    onWalletSelect(option) {
        if (option.isCoinbaseAccount) {
            ...
            this.initializeCoinbaseTopUp(option.accountSelected, Object.assign(Object.assign({}, parsedAmount), { coin: option.accountSelected.currency.code }));
        }
        else {
            ...
            this.calculateAmount(wallet)
                ...
                this.initializeTopUp(wallet, Object.assign(Object.assign({}, parsedAmount), { coin: wallet.coin }));
            })
                .catch(err => {
                this.onGoingProcessProvider.clear();
                this._resetValues();
