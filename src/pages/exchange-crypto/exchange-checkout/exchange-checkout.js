...
let ExchangeCheckoutPage = class ExchangeCheckoutPage {
    constructor(actionSheetProvider, logger, navParams, modalCtrl, changellyProvider, navCtrl, platformProvider, profileProvider, translate, configProvider, currencyProvider, rateProvider, exchangeCryptoProvider, walletProvider, bwcErrorProvider, bwcProvider, onGoingProcessProvider) {
            ...
            this.walletProvider
                ...
                this.changellyProvider
                    ...
                    if (Number(data.result.changellyFee) > 0 ||
                        ...
                        this.logger.debug(`Changelly fee: ${this.exchangeFee} - BitPay fee: ${this.bitpayFee} - Total fee: ${this.totalExchangeFee}`);
                    }
                    if (this.fromWalletSelected.coin == 'bch') {
    ...
    openFinishModal() {
        ...
        modal.onDidDismiss(() => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.navCtrl.push(ChangellyPage, null, { animate: false });
        }));
    }
    openTermsModal() {
...
ExchangeCheckoutPage = __decorate([
    Component({
