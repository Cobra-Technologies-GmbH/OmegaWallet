...
describe('WalletDetailsPage', () => {
    ...
    beforeEach(async(() => {
        ...
        return TestUtils.configurePageTestingModule([WalletDetailsPage]).then(testEnv => {
    ...
    describe('Lifecycle Hooks', () => {
        describe('ionViewWillEnter', () => {
            it('should subscribe to events', () => {
                ...
                expect(subscribeSpy).toHaveBeenCalledWith('Local/WalletUpdate', instance.updateStatus);
                expect(subscribeSpy).toHaveBeenCalledWith('Local/WalletHistoryUpdate', instance.updateHistory);
    ...
    describe('Methods', () => {
        ...
        describe('groupHistory', () => {
            it('should group transactions by month', () => {
                const getTime = (date) => new Date(date).getTime() / 1000;
                const transactions = [
        ...
        describe('isDateInCurrentMonth', () => {
            it('should use timeProvider.isDateInCurrentMonth', () => {
                const spy = spyOn(instance.timeProvider, 'isDateInCurrentMonth').and.callThrough();
                const date = new Date();
...
//# sourceMappingURL=wallet-details.spec.js.map