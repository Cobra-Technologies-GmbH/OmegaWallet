...
describe('ImportWalletPage', () => {
    ...
    describe('Function: processWalletInfo', () => {
        it('should return the correct parsed info', () => {
            const code = "1|mom mom mom mom mom mom mom mom mom mom mom mom|livenet|m/44'/0'/0'|false|btc";
    ...
    describe('Function: importFromFile', () => {
        beforeEach(() => {
            const actionSheetProvider = testBed.get(ActionSheetProvider);
    ...
    describe('Function: importFromMnemonic', () => {
        ...
        it('should return error when use 13 words', () => {
            instance.importForm.controls['words'].setValue('mom1 mom2 mom3 mom4 mom5 mom6 mom7 mom8 mom9 mom10 mom11 mom12 mom13');
            const actionSheetProvider = testBed.get(ActionSheetProvider);
            const modal = ModalMock.instance();
            spyOn(actionSheetProvider, 'createInfoSheet').and.returnValue(modal);
            instance.importFromMnemonic();
            expect(actionSheetProvider.createInfoSheet).toHaveBeenCalledWith('recovery-phrase-length', {
                wordListLength: 13
            });
            expect(modal.present).toHaveBeenCalled();
        });
        it('should not return error when use 12 words with extra spaces', () => {
            instance.importForm.controls['words'].setValue('  mom1 mom2 mom3 mom4 mom5  mom6 mom7 mom8 mom9 mom10 mom11 mom12   ');
            const importMnemonicSpy = spyOn(instance, 'importMnemonic');
            instance.importFromMnemonic();
...
//# sourceMappingURL=import-wallet.spec.js.map