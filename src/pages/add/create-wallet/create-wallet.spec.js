...
describe('CreateWalletPage', () => {
    ...
    /* let instance; */
    beforeEach(async(() => {
        return TestUtils.configurePageTestingModule([CreateWalletPage]).then(testEnv => {
    ...
    /*  describe('setOptsAndCreate function', () => {
       it('should call create function with options', () => {
         ...
         instance.createForm.value.bwsURL = 'https://bws.omega.eco/bws/api';
...
//# sourceMappingURL=create-wallet.spec.js.map