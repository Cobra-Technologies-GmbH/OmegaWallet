...
let CryptoOrderSummaryPage = class CryptoOrderSummaryPage {
    constructor(logger, navParams, modalCtrl, navCtrl, persistenceProvider, platformProvider, profileProvider, walletProvider, bitPayProvider, buyCryptoProvider, errorsProvider, actionSheetProvider) {
        this.logger = logger;
    ...
    openCryptoCoinSelectorModal() {
        let modal = this.modalCtrl.create(CryptoCoinSelectorPage, {
            useAsModal: true
        }, {
            showBackdrop: true,
            enableBackdropDismiss: true
    ...
    openCountrySelectorModal() {
        let modal = this.modalCtrl.create(CountrySelectorPage, {
    ...
    openCryptoPaymentMethodModal() {
        let modal = this.modalCtrl.create(CryptoPaymentMethodPage, {
...
CryptoOrderSummaryPage = __decorate([
    Component({
