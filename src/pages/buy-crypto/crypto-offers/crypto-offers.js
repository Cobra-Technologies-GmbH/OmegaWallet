...
let CryptoOffersPage = class CryptoOffersPage {
    constructor(appProvider, buyCryptoProvider, logger, onGoingProcessProvider, navParams, simplexProvider, navCtrl, profileProvider, currencyProvider, configProvider, walletProvider, wyreProvider, externalLinkProvider, translate, popupProvider, themeProvider) {
    ...
    ionViewWillEnter() {
        ...
        this.offers.wyre.showOffer = this.buyCryptoProvider.isPaymentMethodSupported('wyre', this.paymentMethod, this.coin, this.currency);
    ...
    setFiatCurrency() {
        if (this.currency === this.coin.toUpperCase()) {
            ...
            this.fiatCurrency = _.includes(this.simplexProvider.supportedFiatAltCurrencies, config.wallet.settings.alternativeIsoCode)
