...
describe('AboutPage', () => {
    let fixture;
    let instance;
    beforeEach(async(() => TestUtils.configurePageTestingModule([AboutPage]).then(testEnv => {
    ...
    describe('Lifecycle Hooks', () => {
        describe('ionViewDidLoad', () => {
            ...
            it('should set correct title', () => {
                spyOn(instance.replaceParametersProvider, 'replace').and.returnValue('testTitle');
                spyOn(instance.translate, 'instant').and.returnValue('testVal');
                instance.appProvider.info.nameCase = 'testName';
                instance.ionViewDidLoad();
                expect(instance.translate.instant).toHaveBeenCalledWith('About App');
                expect(instance.replaceParametersProvider.replace).toHaveBeenCalledWith('testVal', { appName: 'testName' });
        ...
        describe('#openExternalLink', () => {
            it('open github repo with correct params', () => {
                ...
                const params = {
                    ...
                    'You can see the latest developments and contribute to this open source app by visiting our project on GitHub.': 'You can see the latest developments and contribute to this open source app by visiting our project on GitHub.'
                };
                spyOn(instance.translate, 'instant').and.callFake(myParam => {
                    return params[myParam];
                });
                instance.openExternalLink();
                expect(instance.externalLinkProvider.open).toHaveBeenCalledWith('https://github.com/bitpay/testRepo/tree/testHash', true, 'Open GitHub Project', 'You can see the latest developments and contribute to this open source app by visiting our project on GitHub.', 'Open GitHub', 'Go Back');
            });
        });
