...
describe('FeePolicyPage', () => {
    ...
    describe('Lifecycle Hooks', () => {
        describe('ionViewDidEnter', () => {
            ...
            it('should set new fee level and update current values', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            it('should log and set new error if getFeeLevels fails', () => __awaiter(void 0, void 0, void 0, function* () {
