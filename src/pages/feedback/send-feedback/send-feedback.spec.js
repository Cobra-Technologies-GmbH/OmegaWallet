...
describe('SendFeedbackPage', () => {
    let fixture;
    let instance;
    beforeEach(async(() => TestUtils.configurePageTestingModule([SendFeedbackPage]).then(testEnv => {
    ...
    describe('Methods', () => {
        describe('#showAppreciationSheet', () => {
            it('should create new info sheet', () => {
                const appSheet = spyOn(instance.actionSheetProvider, 'createInfoSheet').and.returnValue({
                    present() { },
                    onDidDismiss() { }
                });
...
//# sourceMappingURL=send-feedback.spec.js.map