...
import { ExpandableHeaderComponent, ExpandableHeaderFooterComponent, ExpandableHeaderPrimaryComponent } from './expandable-header';
import { Subject } from 'rxjs/Subject';
let fixture;
let instance;
let contentMock;
let ionScrollSubject;
...
], TestHostComponent.prototype, "expandableHeader", void 0);
...
describe('ExpandableHeaderComponent', () => {
    beforeEach(async(() => TestUtils.beforeEachCompiler([
        ...
        ionScrollSubject = new Subject();
        contentMock = {
            ionScroll: ionScrollSubject.asObservable()
        };
        instance.scrollArea = contentMock;
    })));
    afterEach(() => {
        fixture.destroy();
    });
    describe('Initialization', () => {
        ...
        it('should apply transforms on scroll events', () => {
            ...
            ionScrollSubject.next(scrollEventMock);
            expect(scrollSpy).toHaveBeenCalledWith(scrollEventMock.scrollTop, instance.getNewHeaderHeight(scrollEventMock.scrollTop));
        });
    });
    describe('Methods', () => {
        beforeEach(() => {
        ...
        describe('#computeTransformations', () => {
            it('should not apply visible transforms if the user has not yet scrolled', () => {
                const transformations = instance.computeTransformations(0, instance.headerHeight);
...
//# sourceMappingURL=expandable-header.spec.js.map